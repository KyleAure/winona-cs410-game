...
public class AdjacencyListMaker {
    ...
    //all temp values
    Space new1 = new Space(1);
    Space new2 = new Space(2);
    Space new3 = new Space(3);
    Space new4 = new Space(4);

    public List<Space> makeEasyAdjacencyList(Space s) { //creates adjacency list for spaces in easy mode
    ...
    public List<Space> makeMediumAdjacencyList(Space s) { //creates adjacency list for spaces in medium mode
    ...
    public List<Space> makeHardAdjacencyList(Space s) { //creates adjacency list for spaces in hard mode
